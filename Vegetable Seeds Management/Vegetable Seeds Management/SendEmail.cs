...
namespace Vegetable_Seeds_Management
{
    public class SendEmail
    {
        ...
        protected void WastedSeeds(object sender, EventArgs e)
        {
            ...
            {
ted Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False"))
   
                using (SqlConnection sqlCon = new SqlConnection(@"Data Source=desktop-ub0lhnh;Initial Catalog=project;Integra             {
