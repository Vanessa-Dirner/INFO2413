...
CREATE TABLE inventory (
 ...
 insert into inventory (batch, expirationdate, quantity, seedtype, seedname, plantingtime)
  values ('B0011', '2023-01-14'  ,'05000'  , 'Harvested', 'Sunflower', 'Spring' ),
         ('B0012', '2022-07-22'  ,'10000'  , 'Bought', 'Tomato', 'Spring'),
         ('B0013', '2024-01-10'  ,'05000'  , 'Bought', 'Apple', 'Spring'),
         ('B0014', '2023-12-23'  ,'05000'  , 'Harvested', 'Grape', 'Spring'),
         ('B0015', '2022-04-20'  ,'05000'  , 'Harvested', 'Blueberry', 'Winter'),
         ('B0021', '2020-01-10'  ,'10000'  , 'Harvested','Pear', 'Summer' ),
         ('B0054', '2019-07-22'  ,'01843'  , 'Sunflower', 'Titan', 'Winter'),
         ('B0572', '2021-01-10'  ,'24052'  , 'Bought', 'Celery', 'Winter'),
         ('B0300', '2022-01-01'  ,'05921'  , 'Bought', 'Lemon', 'Summer'),
